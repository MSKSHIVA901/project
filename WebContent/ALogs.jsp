...
<div class="container">
	...
	<div class="collapse navbar-collapse navbar-right navbar-main-collapse">
		<ul class="nav navbar-nav">
			...
			<li>
			<a href="ALogs.jsp">Users Activity</a>
			</li>
			<li>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<h1 class="brand-heading">User Actions</h1>
				<p class="intro-text">
<table width="100%" border="1 solid red" style="font-size: 16px;">
<tr style="color: white;"><th>UserID</th><th>Activity</th><th>Date</th></tr>
<%
...
while(rs.next()){
%>
<tr style="color: white;"><td><%=rs.getString(1) %></td><td><%=rs.getString(2) %></td>
