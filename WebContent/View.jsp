	...
	<div class="row">
		<h2>Search Key Response</h2>
			<table class="w3-table w3-blue" style="width:1150px;text-align: center;" border="1 solid red">
											...
											ResultSet r=DBConnection.getFile1(uid1);
			while(r.next())
			{
					 %>
										 		<tr style="color: white;">
													<td style="color: black;"><%= r.getString("email") %></td>
													<td style="color: black;"><%= r.getString("indexid") %></td>
													<td style="color: black;"><%= r.getString("filename") %></td>
													<td style="color: black;"><a href="DownloadOriginal?indexid=<%= r.getString("indexid") %>">Click To View File</a></td>
												</tr>
					 <%
				}
											%>
